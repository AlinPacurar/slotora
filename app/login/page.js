    ...
    <div className="min-h-screen bg-stone-50 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm w-full max-w-md p-8">
          ...
          <p className="text-sm text-stone-400 mb-6">Log in to manage your oras.</p>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-stone-400 font-medium">or log in with email</span>
            <div className="flex-1 h-px bg-stone-200" />
          </div>
          ...
          <p className="text-center text-sm text-stone-400 mt-6">
            ...
            <a href="/signup" className="text-sky-500 font-medium hover:underline">Sign up free</a>
          </p>
        </div>
      </div>
    </div>
